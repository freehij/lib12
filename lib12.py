...
class CustomDict:
    ...
    def set(self,key:__import__("typing").Any,value:__import__("typing").Any)->None:self.__i.append(key)if key not in self.__i else None;self.__j.insert(self.__i.index(key),value)
